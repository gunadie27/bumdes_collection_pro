...
/// A class that contains all theme configurations for the debt collection application.
/// Implements Indonesian Trust Palette with Contemporary Professional Minimalism design.
class AppTheme {
  AppTheme._();

  // Indonesian Trust Palette - Core Colors
  static const Color primaryLight = Color(0xFF2E7D32); // Deep forest green
  static const Color primaryVariantLight =
      Color(0xFF1B5E20); // Darker forest green
  static const Color secondaryLight = Color(0xFF8D6E63); // Warm brown
  ...
  static const Color errorLight = Color(0xFFC62828); // Clear red for overdue
  static const Color warningLight = Color(0xFFF57C00); // Amber for reminders
  static const Color successLight = Color(0xFF388E3C); // Confirmation green
  static const Color accentLight =
      Color(0xFFFF6F00); // Indonesian sunset orange
  ...
  static const Color secondaryDark = Color(0xFFA1887F); // Lighter brown
  static const Color secondaryVariantDark =
      Color(0xFF8D6E63); // Original secondary as variant
  ...
  static const Color accentDark = Color(0xFFFFAB40); // Lighter orange accent
  ...
  static const Color shadowLight = Color(0x1A000000); // Soft gray shadows
  static const Color shadowDark = Color(0x1AFFFFFF);

  // Divider colors - subtle separation
  static const Color dividerLight =
      Color(0xFFE0E0E0); // Subtle separation lines
  ...
  static const Color textDisabledLight = Color(0xFFBDBDBD); // Disabled state
  ...
  static const Color textDisabledDark =
      Color(0xFF616161); // Disabled state dark
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme - professional header with trust-building design
    ...
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 2.0, // Subtle elevation as specified
      shadowColor: shadowLight,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12.0), // Rounded corners for warmth
      ),
      margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
    ),

    // Bottom navigation - field collector friendly
    ...
    // Floating Action Button - context-aware morphing button
    ...
    // Button themes - thumb-friendly for one-handed operation
    ...
    // Typography - Inter font family for clarity and Indonesian character support
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration - optimized for field data entry
    ...
    // Switch theme - status-driven color application
    ...
    // Progress indicators - semantic color application
    ...
    // List tile theme - for account listings
  ...
  /// Dark theme - adapted for night usage and low-light conditions
  ...
  static TextStyle currencyTextStyle({required bool isLight}) {
    return GoogleFonts.jetBrainsMono(
      fontSize: 16,
      fontWeight: FontWeight.w500,
      color: isLight ? textPrimaryLight : textPrimaryDark,
  ...
  /// Status color helpers for semantic color application
